        ...
        inputSchema: {
          ...
          properties: {
            type: {
              type: 'string',
              description:
                "Type of place (e.g., 'restaurants', 'gas stations', 'hotels', 'coffee')",
            },
            near: {
              type: 'string',
  ...
  try {
    switch (name) {
      ...
      case 'maps_drop_pin': {
        ...
        return {
          content: [
            { type: 'text', text: `Dropped pin at: ${address}${label ? ` (${label})` : ''}` },
          ],
        };
      }
      ...
      case 'maps_nearby': {
        ...
        return {
          content: [
            { type: 'text', text: `Searching for ${type}${near ? ` near ${near}` : ' nearby'}` },
          ],
        };
      }
